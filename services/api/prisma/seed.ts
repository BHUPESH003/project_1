...
import { Pool } from 'pg';
import { UserRole, CategoryStatus, SellerStatus } from '@repo/types';
  ...
  try {
    const categorySeeds = [
      {
        ...
        displayOrder: 1,
        iconPath:
          'https://images.unsplash.com/photo-1563986768494-4dee2763ff0f?auto=format&fit=crop&w=200&q=80',
      },
      {
        id: 'hardware',
        name: 'Hardware',
    ...
    await prisma.userAddress.create({
      data: {
        userId: testUser.id,
        label: 'Home',
        addressLine: '26, Ghoshgarh Jori Rd, Sonipat, Haryana',
        receiverName: 'Test User',
        receiverPhone: testUser.phone,
        latitude: new Prisma.Decimal('28.35365289'),
        longitude: new Prisma.Decimal('76.83508163'),
      },
    });
    ...
    const upsertSeller = async (def: any) => {
      ...
      return prisma.seller.upsert({
        ...
        create: {
          ...
          status: SellerStatus.ONLINE,
          statusUpdatedAt: new Date(),
          pricePerPage: rest.pricePerPage ?? null,
        },
      });
    };
    ...
    const upsertProduct = async (product: {
      ...
      await prisma.product.upsert({
        where: {
          sellerId_name: { sellerId: product.sellerId, name: product.name },
        },
        update: {
    ...
    const printProducts = [
      // Fast Print Shop (+919876543210)
      {
        ...
        description: 'Standard 80gsm A4 paper, single side',
      ...
      },
      {
        ...
        description: 'High-quality 100gsm A4 color print',
        category: 'Printing Services',
        price: '2.00',
        image:
      ...
      },
      {
        ...
        description: 'Full-color A3 glossy poster print',
        category: 'Printing Services',
        price: '15.00',
        mrp: '20.00',
        image:
      ...
      },
      {
        phone: '+919876543210',
        name: 'Spiral Binding',
        description: 'Spiral bind your documents up to 200 pages',
      ...
      },
      {
        phone: '+919876543210',
        name: 'Lamination A4',
        description: 'Glossy lamination for A4 sheets',
        category: 'Finishing Services',
        price: '8.00',
        image:
          'https://images.unsplash.com/photo-1612198273689-b92fc0c8c88b?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919876543210',
        name: 'Photo Print 4x6',
        description: 'Standard 4x6 glossy photo print',
      ...
      {
        phone: '+919876543210',
        name: 'Business Card Print (500)',
        description: 'Premium matte finish, 500 cards',
      ...
      },
      {
        ...
        description: 'Tri-fold A4 brochure, full color',
        category: 'Marketing Materials',
        price: '10.00',
        image:
      ...
      },
      {
        phone: '+919876543210',
        name: 'ID Card Print',
        description: 'CR80 size ID card, both sides',
      ...
      },
      {
        phone: '+919876543210',
        name: 'Envelope Print',
        description: 'A4 envelope with custom branding',
        category: 'Stationery Print',
        price: '5.00',
        image:
          'https://images.unsplash.com/photo-1557672172-298e090bd0f1?auto=format&fit=crop&w=400&q=80',
      },
      ...
      // Sonipat Print Hub (+919999999999)
      {
        ...
        description: 'Full-color brochures on premium 130gsm paper',
        category: 'Marketing Materials',
        price: '3.50',
        mrp: '5.00',
        image:
      ...
      {
        phone: '+919999999999',
        name: 'A2 Banner Print',
        description: 'High-resolution A2 banner print',
        category: 'Banners',
        price: '80.00',
        image:
          'https://images.unsplash.com/photo-1557672172-298e090bd0f1?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Hardcover binding up to 300 pages',
        category: 'Binding Services',
        price: '150.00',
        mrp: '200.00',
        image:
      ...
      {
        phone: '+919999999999',
        name: 'Roll-Up Banner 2x6ft',
        description: 'Premium roll-up banner with stand',
        category: 'Banners',
        price: '450.00',
        image:
          'https://images.unsplash.com/photo-1561736778-92e52a7769ef?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919999999999',
        name: 'Passport Photo Print',
        description: 'Set of 8 passport-size photos',
        category: 'Photo Printing',
        price: '40.00',
        mrp: '60.00',
        image:
      ...
      {
        phone: '+919999999999',
        name: 'Flyer A5 Print (100)',
        description: '100 single-side A5 flyers, color',
        category: 'Marketing Materials',
        price: '120.00',
        image:
          'https://images.unsplash.com/photo-1611532736597-de2d4265fba3?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919999999999',
        name: 'Letterhead Design & Print',
        description: 'Custom letterhead 100 sheets',
        category: 'Stationery Print',
        price: '200.00',
        image:
          'https://images.unsplash.com/photo-1586281380349-632531db7ed4?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919999999999',
        name: 'Notepad Printing (50 sheets)',
        description: 'Custom branded notepad',
        category: 'Stationery Print',
        price: '80.00',
        image:
      ...
      },
      {
        phone: '+919999999999',
        name: 'Stamp Making',
        description: 'Self-inking rubber stamp',
      ...
      {
        phone: '+919999999999',
        name: 'Lamination Pouch A3',
        description: 'A3 glossy lamination pouch',
        category: 'Finishing Services',
        price: '15.00',
        image:
          'https://images.unsplash.com/photo-1612198273689-b92fc0c8c88b?auto=format&fit=crop&w=400&q=80',
    ...
    const hardwareProducts: Array<{
      ...
      // Raj Hardware Store (+919555555555)
      {
        ...
        description: 'Chrome finish tap for kitchen/bathroom',
        category: 'Plumbing Supplies',
        price: '45.00',
        mrp: '65.00',
        image:
          'https://images.unsplash.com/photo-1585518419759-15bc0e834e6b?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919555555555',
        name: 'PVC Pipe 1 inch',
        description: '10 meter durable PVC pipe',
        category: 'Plumbing Supplies',
        price: '35.00',
        image:
          'https://images.unsplash.com/photo-1584622181636-ffa00913074e?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919555555555',
      ...
      },
      {
        ...
        description: 'Pack of 10 CPVC elbow fittings',
        category: 'Plumbing Supplies',
        price: '12.00',
        image:
      ...
      },
      {
        ...
        description: 'Pack of 5 PTFE thread seal tapes',
        category: 'Plumbing Supplies',
        price: '5.00',
        image:
          'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Plastic & steel mixed anchors, 100pc',
        category: 'Fasteners',
        price: '15.00',
        mrp: '22.00',
        image:
          'https://images.unsplash.com/photo-1587145820098-4b6bea20e3cc?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919555555555',
        name: 'Measuring Tape 5m',
        description: 'Auto-lock stainless steel tape',
      ...
      },
      {
        ...
        description: 'Aluminium spirit level, 3 vials',
        category: 'Measuring Tools',
        price: '22.00',
        image:
          'https://images.unsplash.com/photo-1572981779307-38b8cabb2407?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Grey tile adhesive, wall & floor',
      ...
      },
      {
        ...
        description: 'Flat & Phillips insulated screwdrivers',
        category: 'Hand Tools',
        price: '20.00',
        image:
      ...
      // BuildMart Hardware (+919666666666)
      {
        ...
        description: 'Flexible copper wire, 100m roll',
      ...
      },
      {
        phone: '+919666666666',
        name: 'LED Bulb 15W',
        description: 'Cool white LED, energy efficient',
        category: 'Electrical Supplies',
        price: '25.00',
        image:
          'https://images.unsplash.com/photo-1567864162381-03c3d0c0b0db?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919666666666',
        name: 'MCB Switch 32A',
      ...
      },
      {
        ...
        description: '2m cord, surge protected',
        category: 'Electrical Supplies',
        price: '180.00',
        image:
          'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919666666666',
        name: 'Conduit Pipe 25mm',
        description: 'PVC conduit for wiring, 3m length',
        category: 'Electrical Supplies',
        price: '30.00',
        image:
          'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Plastic surface mount junction box',
        category: 'Electrical Supplies',
        price: '12.00',
        image:
          'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Auto-range LCD digital multimeter',
      ...
      },
      {
        phone: '+919666666666',
        name: 'Wire Stripper',
        description: 'Self-adjusting ergonomic wire stripper',
        category: 'Electrical Tools',
        price: '45.00',
        image:
          'https://images.unsplash.com/photo-1530124566582-a618bc2615dc?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Pencil-type soldering iron with stand',
        category: 'Electrical Tools',
        price: '65.00',
        image:
          'https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919666666666',
        name: 'Electrical Tape 10m',
        description: 'Black PVC insulation tape, pack of 5',
        category: 'Electrical Supplies',
        price: '10.00',
        image:
          'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=400&q=80',
      ...
      // Super Tools & Hardware (+919777777777)
      {
        ...
        description: 'Comfortable TPR grip, 500g',
        category: 'Hand Tools',
        price: '15.00',
        image:
          'https://images.unsplash.com/photo-1578734854309-c58b20fbf6ee?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919777777777',
        name: 'Power Drill Machine',
        description: '13mm chuck, variable speed, 700W',
        category: 'Power Tools',
        price: '85.00',
        mrp: '100.00',
        image:
          'https://images.unsplash.com/photo-1618220179857-7c76a6b50e6d?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919777777777',
        name: 'Angle Grinder 4.5 inch',
        description: '850W angle grinder with guard',
        category: 'Power Tools',
        price: '120.00',
        mrp: '150.00',
        image:
      ...
      },
      {
        phone: '+919777777777',
        name: 'Jigsaw Machine',
        description: '500W corded jigsaw, 5 blades',
        category: 'Power Tools',
        price: '180.00',
        image:
          'https://images.unsplash.com/photo-1618220179857-7c76a6b50e6d?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Metric Allen key set with holder',
        category: 'Hand Tools',
        price: '12.00',
        image:
          'https://images.unsplash.com/photo-1530124566582-a618bc2615dc?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: '1200W circular saw with laser guide',
        category: 'Power Tools',
        price: '350.00',
        mrp: '420.00',
        image:
      ...
      },
      {
        ...
        description: 'Combination, needle-nose & cutting pliers',
        category: 'Hand Tools',
        price: '35.00',
        image:
          'https://images.unsplash.com/photo-1530124566582-a618bc2615dc?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919777777777',
        name: 'Drill Bit Set 25-Piece',
        description: 'HSS titanium coated bit set',
        category: 'Power Tools',
        price: '50.00',
        mrp: '70.00',
        image:
      ...
      {
        phone: '+919777777777',
        name: 'Toolbox 14 inch',
        description: 'Plastic cantilever toolbox with tray',
        category: 'Storage',
        price: '80.00',
        image:
          'https://images.unsplash.com/photo-1530124566582-a618bc2615dc?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Cut-resistant work safety gloves',
      ...
      },
      {
        phone: '+919888888888',
        name: 'Wall Paint 10L',
        description: 'Premium interior wall paint, eggshell',
        category: 'Paints & Finishes',
        price: '180.00',
        image:
      ...
      },
      {
        ...
        description: '9" roller with frame, tray & 2 covers',
      ...
      {
        phone: '+919888888888',
        name: 'Putty Knife 4 inch',
        description: 'Flexible stainless blade putty knife',
        category: 'Painting Tools',
        price: '10.00',
        image:
          'https://images.unsplash.com/photo-1530124566582-a618bc2615dc?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919888888888',
        name: 'Primer Coat 4L',
        description: 'Water-based interior wall primer',
        category: 'Paints & Finishes',
        price: '90.00',
        mrp: '120.00',
        image:
      ...
      },
      {
        ...
        description: 'Pack of 4 masking tapes, 50m each',
        category: 'Painting Tools',
        price: '15.00',
        image:
          'https://images.unsplash.com/photo-1572981779307-38b8cabb2407?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'OPC 43 grade Portland cement',
        category: 'Construction Materials',
        price: '320.00',
        image:
          'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919888888888',
        name: 'Steel Trowel 12 inch',
        description: 'Pool trowel for concrete finishing',
      ...
      },
      {
        phone: '+919888888888',
        name: 'Safety Helmet',
        description: 'ISI-marked construction safety helmet',
        category: 'Safety Equipment',
        price: '45.00',
        mrp: '60.00',
        image:
      ...
      {
        phone: '+919100000001',
        name: 'HDPE Water Tank 500L',
        description: 'Triple-layer food-grade water storage tank',
        category: 'Plumbing Supplies',
        price: '2500.00',
        mrp: '3000.00',
        image:
      ...
      },
      {
        ...
        description: 'Deep well submersible water pump',
        category: 'Plumbing Supplies',
        price: '1800.00',
        image:
          'https://images.unsplash.com/photo-1585518419759-15bc0e834e6b?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919100000001',
        name: 'GI Wire 18 gauge',
        description: '5kg coil of galvanized iron wire',
        category: 'Construction Materials',
        price: '65.00',
        image:
          'https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919100000001',
        name: 'M-Seal Epoxy Compound',
        description: 'Quick-seal plumbing repair compound',
        category: 'Plumbing Supplies',
        price: '20.00',
        image:
          'https://images.unsplash.com/photo-1584622181636-ffa00913074e?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919100000001',
        name: 'Safety Goggles',
        description: 'Anti-scratch UV-protected safety glasses',
        category: 'Safety Equipment',
        price: '18.00',
        image:
          'https://images.unsplash.com/photo-1587145820098-4b6bea20e3cc?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Heavy-duty 60cm manual tile cutter',
        category: 'Masonry Tools',
        price: '450.00',
        mrp: '550.00',
        image:
      ...
      {
        phone: '+919100000001',
        name: 'Rubber Mallet 32oz',
        description: 'Fiberglass handle rubber head mallet',
        category: 'Hand Tools',
        price: '22.00',
        image:
          'https://images.unsplash.com/photo-1578734854309-c58b20fbf6ee?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919100000001',
        name: 'Chain Block 1 Ton',
        description: 'Manual chain hoist, 1 tonne capacity',
      ...
      {
        phone: '+919100000001',
        name: 'Concrete Nails Box',
        description: '3 inch cut-type concrete nails, 1kg',
        category: 'Fasteners',
        price: '18.00',
        image:
          'https://images.unsplash.com/photo-1587145820098-4b6bea20e3cc?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919100000001',
        name: 'MS Flat Bar 25x6mm',
        description: 'Mild steel flat bar, 6 meter length',
        category: 'Construction Materials',
        price: '180.00',
        image:
          'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=400&q=80',
      ...
      // Pro Build Supplies (+919100000002)
      {
        ...
        description: 'MS angle iron, 6m length',
        category: 'Construction Materials',
        price: '220.00',
        image:
          'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919100000002',
        name: 'Welding Electrode 6013',
        description: 'Pack of 25 mild steel electrodes',
      ...
      {
        phone: '+919100000002',
        name: 'Fibre Sheet 10x4ft',
        description: 'Corrugated fibre cement roofing sheet',
      ...
      },
      {
        ...
        description: 'Dr Fixit waterproof coating, 5L',
      ...
      {
        phone: '+919100000002',
        name: 'Block Level Laser',
        description: '3-line self-leveling laser level',
        category: 'Measuring Tools',
        price: '650.00',
        image:
          'https://images.unsplash.com/photo-1572981779307-38b8cabb2407?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919100000002',
        name: 'Crow Bar 3ft',
        description: 'High carbon steel pry bar/crow bar',
        category: 'Hand Tools',
        price: '55.00',
        image:
          'https://images.unsplash.com/photo-1530124566582-a618bc2615dc?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'HVLP air spray gun, 600ml cup',
        category: 'Painting Tools',
        price: '280.00',
        mrp: '350.00',
        image:
      ...
      {
        phone: '+919100000002',
        name: 'Tarpaulin Sheet 12x18ft',
        description: 'Heavy-duty UV-resistant blue tarpaulin',
        category: 'Construction Materials',
        price: '120.00',
        image:
          'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919100000002',
        name: 'Bolt & Nut Set M8',
        description: 'Zinc-plated M8 bolts & nuts, 50 sets',
        category: 'Fasteners',
        price: '35.00',
        image:
          'https://images.unsplash.com/photo-1587145820098-4b6bea20e3cc?auto=format&fit=crop&w=400&q=80',
    ...
    const sportsProducts: Array<{
      ...
      // Champion Sports (+919200000001)
      {
        ...
        description: 'Grade 1 Kashmir willow, full-size bat',
        category: 'Cricket',
        price: '650.00',
        mrp: '850.00',
        image:
      ...
      {
        phone: '+919200000001',
        name: 'Leather Cricket Ball (3-pack)',
        description: 'Red seam leather ball, match quality',
        category: 'Cricket',
        price: '250.00',
        image:
          'https://images.unsplash.com/photo-1531415074968-036ba1b575da?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'SG-style full-finger batting gloves',
        category: 'Cricket',
        price: '350.00',
        mrp: '450.00',
        image:
      ...
      },
      {
        phone: '+919200000001',
        name: 'Cricket Helmet',
        description: 'Steel grill helmet, adjustable',
        category: 'Cricket',
        price: '800.00',
        image:
          'https://images.unsplash.com/photo-1531415074968-036ba1b575da?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Yonex-style graphite frame racket',
        category: 'Badminton',
        price: '550.00',
        mrp: '700.00',
        image:
      ...
      {
        phone: '+919200000001',
        name: 'Shuttlecock (6-pack Feather)',
        description: 'Genuine feather shuttlecocks',
        category: 'Badminton',
        price: '180.00',
        image:
          'https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Durable PU match football',
        category: 'Football',
        price: '350.00',
        mrp: '450.00',
        image:
      ...
      },
      {
        ...
        description: 'Lightweight EVA foam shin guards',
        category: 'Football',
        price: '120.00',
        image:
          'https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'BPA-free double-wall insulated bottle',
      ...
      {
        phone: '+919200000001',
        name: 'Sports Bag Backpack',
        description: 'Multi-pocket 30L sports duffel',
        category: 'Accessories',
        price: '500.00',
        image:
      ...
      {
        phone: '+919200000002',
        name: 'Dumbbell Set 5–20kg',
        description: 'Hex rubber dumbbell set, 5 pairs',
      ...
      },
      {
        ...
        description: '5 levels, loop & long bands included',
        category: 'Gym Equipment',
        price: '350.00',
        mrp: '500.00',
        image:
      ...
      },
      {
        phone: '+919200000002',
        name: 'Yoga Mat 6mm',
        description: 'Non-slip TPE eco yoga mat with strap',
      ...
      {
        phone: '+919200000002',
        name: 'Skipping Rope Bearing',
        description: 'Ball bearing steel cable speed rope',
      ...
      },
      {
        ...
        description: 'Multi-grip doorframe pull-up bar',
        category: 'Gym Equipment',
        price: '800.00',
        image:
          'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919200000002',
        name: 'Gym Gloves',
        description: 'Half-finger weight training gloves',
        category: 'Gym Equipment',
        price: '180.00',
        mrp: '250.00',
        image:
      ...
      },
      {
        ...
        description: 'High-density EVA muscle recovery roller',
        category: 'Recovery',
        price: '350.00',
        image:
          'https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Cast iron powder-coated kettlebell',
        category: 'Gym Equipment',
        price: '1200.00',
        mrp: '1500.00',
        image:
      ...
      },
      {
        ...
        description: '4 inch wide leather weightlifting belt',
        category: 'Gym Equipment',
        price: '550.00',
        image:
          'https://images.unsplash.com/photo-1561731216-c3a4d99437d5?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Double-wheel ab roller with knee mat',
        category: 'Gym Equipment',
        price: '250.00',
        mrp: '350.00',
        image:
      ...
      // PlayMore Sports (+919200000003)
      {
        ...
        description: 'Outdoor rubber basketball, grip texture',
        category: 'Basketball',
        price: '400.00',
        mrp: '550.00',
        image:
          'https://images.unsplash.com/photo-1546519638405-a9f9f16d7248?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919200000003',
        name: 'Basketball Net Replacement',
        description: 'All-weather nylon hoop net',
        category: 'Basketball',
        price: '80.00',
        image:
          'https://images.unsplash.com/photo-1546519638405-a9f9f16d7248?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: '2 bats, 6 balls, net & post set',
        category: 'Table Tennis',
        price: '350.00',
        mrp: '480.00',
        image:
          'https://images.unsplash.com/photo-1611251135345-18c56206b863?auto=format&fit=crop&w=400&q=80',
      },
      {
        phone: '+919200000003',
        name: 'TT Rubber Sheet Pro',
        description: 'High-tension speed rubber, ITTF approved',
        category: 'Table Tennis',
        price: '280.00',
        image:
          'https://images.unsplash.com/photo-1611251135345-18c56206b863?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Mikasa-style 18-panel volleyball',
        category: 'Volleyball',
        price: '380.00',
        mrp: '500.00',
        image:
      ...
      {
        phone: '+919200000003',
        name: 'Volleyball Net 9.5m',
        description: 'Official size steel cable volleyball net',
        category: 'Volleyball',
        price: '450.00',
        image:
          'https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919200000003',
        name: 'Running Shoes Size 8-11',
        description: 'Lightweight mesh running shoes, unisex',
        category: 'Footwear',
        price: '1200.00',
        mrp: '1600.00',
        image:
      ...
      {
        phone: '+919200000003',
        name: 'Sports Socks (6-pair)',
        description: 'Cushioned ankle sports socks pack',
        category: 'Apparel',
        price: '150.00',
        image:
          'https://images.unsplash.com/photo-1523362628745-0c100150b504?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Neoprene adjustable knee support',
      ...
      },
      {
        ...
        description: 'Compact 30-piece sports first aid kit',
        category: 'Accessories',
        price: '250.00',
        image:
          'https://images.unsplash.com/photo-1530124566582-a618bc2615dc?auto=format&fit=crop&w=400&q=80',
      ...
      {
        phone: '+919200000004',
        name: 'Treadmill Manual',
        description: 'Foldable manual treadmill, 100kg capacity',
        category: 'Cardio Equipment',
        price: '8500.00',
        mrp: '11000.00',
        image:
      ...
      {
        phone: '+919200000004',
        name: 'Exercise Cycle Upright',
        description: 'Magnetic resistance upright cycle',
        category: 'Cardio Equipment',
        price: '6500.00',
        mrp: '8000.00',
        image:
      ...
      },
      {
        ...
        description: 'Olympic style barbell + weight plates',
        category: 'Gym Equipment',
        price: '4500.00',
        mrp: '5500.00',
        image:
      ...
      },
      {
        ...
        description: 'Genuine leather training boxing gloves',
        category: 'Boxing & MMA',
        price: '1200.00',
        mrp: '1600.00',
        image:
      ...
      {
        phone: '+919200000004',
        name: 'Punching Bag 4ft',
        description: 'Heavy canvas bag with chain hanger',
        category: 'Boxing & MMA',
        price: '2200.00',
        mrp: '2800.00',
        image:
      ...
      {
        phone: '+919200000004',
        name: 'Hockey Stick FG',
        description: 'Carbon fibre field hockey stick',
        category: 'Hockey',
        price: '1800.00',
        mrp: '2200.00',
        image:
      ...
      },
      {
        ...
        description: 'Graphite frame with string & grip',
        category: 'Tennis',
        price: '1500.00',
        mrp: '2000.00',
        image:
      ...
      },
      {
        ...
        description: 'All-court pressurized tennis balls',
        category: 'Tennis',
        price: '180.00',
        image:
          'https://images.unsplash.com/photo-1622279457486-62dcc4a431d6?auto=format&fit=crop&w=400&q=80',
      },
      {
        ...
        description: 'Anti-fog UV-protected swim goggles',
        category: 'Swimming',
        price: '350.00',
        mrp: '500.00',
        image:
      ...
      },
      {
        ...
        description: 'CPSC certified road cycling helmet',
        category: 'Cycling',
        price: '900.00',
        mrp: '1200.00',
        image:
          'https://images.unsplash.com/photo-1544191696-102dbeb5ac79?auto=format&fit=crop&w=400&q=80',
      },
    ];
        ...
        for (let j = 0; j < products.length; j++) {
          await prisma.cartItem.create({
            data: {
              ...
              quantity: 1 + j,
              payload: {},
              priceAtAdd: new Prisma.Decimal(
                products[j].price?.toString() || '0',
              ),
            },
          });
        }
